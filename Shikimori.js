...
(function () {
    ...
    /**
     * Отфильтровать 18+ жанры, если включено hide_adult.
     * Сравнивает name/russian без учёта регистра.
     */
    ...
    function fallbackSearch(data) {
        ...
        searchTmdbMulti(queries, shikiYear, desiredType,
            ...
            function (item) {
                ...
                var exactTitle = itemTitles.some(function (title) {
                    return shikiTitles.indexOf(title) !== -1;
                });
